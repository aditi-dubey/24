...
import com.tavant.practicalassissmentrestapi.*;
import com.tavant.practicalassissmentrestapi.errorresponse.ApiError;
import com.tavant.practicalassissmentrestapi.errorresponse.ApiSubError;

import lombok.extern.slf4j.Slf4j;

@Order(value = Ordered.HIGHEST_PRECEDENCE)
@ControllerAdvice
@Slf4j // used to take logsa
